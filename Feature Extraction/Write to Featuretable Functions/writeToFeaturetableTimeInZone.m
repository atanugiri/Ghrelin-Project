...
% For all IDs in idList using extractTimeInZone()
    ...
    exec(conn, ...
        ...
        "ADD COLUMN IF NOT EXISTS time_in_nest FLOAT" ...
        );
    ...
    for i = 1:length(idList)
        ...
        try
            [t9, t5, t2, t0_5, t_c, t_n] = extractTimeInZone(id, conn);

            if any(isnan([t9, t5, t2, t0_5, t_c, t_n]))
            ...
            updateSQL = sprintf( ...
                ...
                "time_in_center = %f, time_in_nest = %f WHERE id = %d", ...
                t9, t5, t2, t0_5, t_c, t_n, id);

            exec(conn, updateSQL);
            fprintf("ID %d: time = [%.2f, %.2f, %.2f, %.2f, %.2f, %.2f] " + ...
                "(updated)\n", id, t9, t5, t2, t0_5, t_c, t_n);
            nUpdated = nUpdated + 1;
