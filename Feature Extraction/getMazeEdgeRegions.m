...
%
% getMazeEdgeRegions: Return feeder and center zone edges for a given maze quadrant.
%
%   edgeStruct = getMazeEdgeRegions(quadrant, center_size) returns a structure containing
%   the x- and y-coordinate boundaries (edges) of the four feeder zones and the central zone 
%   for a maze, based on the specified quadrant orientation.
%
%   Input:
