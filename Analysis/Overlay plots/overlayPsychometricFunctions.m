...
% varargin = {'P2L1 Saline_distance_old.fig', ...
%     'P2L1 Ghrelin_distance_old.fig', ...
%     'Sal toyrat_distance_old.fig', ...
%     'Ghr toyrat_distance_old.fig', ...
%     'Sal toystick_distance_old', ...
%     'Ghr toystick_distance_old'};
